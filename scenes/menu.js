...
export const Menu = class extends Phaser.Scene {
  ...
  create () {
    const buttonPressAudio = this.sound.add('button_press')
    ...
    const soundText = this.add.text(this.game.config.width*.44, this.game.config.height*.88, 'Sound On', {fontFamily:'geoffrey', fontSize: 16})
